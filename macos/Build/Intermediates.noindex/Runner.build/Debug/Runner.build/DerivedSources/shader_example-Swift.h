...
#ifndef SHADER_EXAMPLE_SWIFT_H
#define SHADER_EXAMPLE_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="shader_example",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
@class NSApplication;
SWIFT_CLASS("_TtC14shader_example11AppDelegate")
...
SWIFT_CLASS("_TtC14shader_example17MainFlutterWindow")
